 ...
 * with least available CPU, max Energy and max running VMs.
 * @author Adonis Adoni
 * 
 */
public class SingleObjectiveOptimizationMinUtil extends SingleObjectiveOptimization
{
	/**
			...
			AccountingClient client, boolean isTesting, HashMap<String, Double> energyTestValues)
	{
		...
		//inverse Energy and VMs weigthing
		inverseWeighting(normalizedEng);
		inverseWeighting(normalizedVm);
