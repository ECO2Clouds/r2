 ...
 *
 * Represents the Wind Energy Metric that can come from the monitoring collector database
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name="Wind", namespace = E2C_NAMESPACE)
public class Wind extends AbstractMonitoringItem {}
