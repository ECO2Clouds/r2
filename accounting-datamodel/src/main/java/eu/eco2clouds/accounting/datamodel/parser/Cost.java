 ...
 *
 * Represents the Cost Energy Metric that can come from the monitoring collector database
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name="Cost", namespace = E2C_NAMESPACE)
public class Cost extends AbstractMonitoringItem {}
