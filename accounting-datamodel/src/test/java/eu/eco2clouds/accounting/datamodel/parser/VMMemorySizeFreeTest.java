 ...
 */
public class VMMemorySizeFreeTest {

	@Test 
	public void pojo() {
		VMMemorySizeFree oil = new VMMemorySizeFree();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
	...
	public void testXML() throws Exception {
		String oilXML = "<vm_memory_size xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(VMMemorySizeFree.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		VMMemorySizeFree oil = (VMMemorySizeFree) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:vm_memory_size");
