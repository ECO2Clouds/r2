...
public class OilTest {
	...
	public void testXML() throws Exception {
		String oilXML = "<Oil xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(Oil.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		Oil oil = (Oil) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:Oil");
