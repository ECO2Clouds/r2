...
public class PSTest {
	...
	public void testXML() throws Exception {
		String otherXML = "<ps xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(Ps.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		Ps other = (Ps) jaxbUnmarshaller.unmarshal(new StringReader(otherXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:ps");
