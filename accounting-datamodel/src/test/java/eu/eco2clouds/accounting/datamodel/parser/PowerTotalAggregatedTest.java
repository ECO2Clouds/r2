 ...
 */
public class PowerTotalAggregatedTest {

	@Test 
	public void pojo() {
		PowerTotalAggregated power = new PowerTotalAggregated();
		power.setClock(10l);
		power.setName("name");
	...
	public void testXML() throws Exception {
		String co2XML = "<power_total_aggregated xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
							+ "<clock>1381512236</clock>"
							+ "<unity>g\\/kWh</unity>"
							+ "<name>Co2 producted per kWh</name>"
						+ "</power_total_aggregated>";
		
		JAXBContext jaxbContext = JAXBContext.newInstance(PowerTotalAggregated.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		PowerTotalAggregated co2 = (PowerTotalAggregated) jaxbUnmarshaller.unmarshal(new StringReader(co2XML));
	...
	public void objectToXml() throws Exception {
		PowerTotalAggregated co2 = new PowerTotalAggregated();
		co2.setClock(10l);
		co2.setName("name");
		co2.setUnity("units");
		co2.setValue(1.0d);
		...
		XPath xpath = XPath.newInstance("//bnf:power_total_aggregated");
