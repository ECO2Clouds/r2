 ...
 */
public class VMMemorySizeTotalTest {

	@Test 
	public void pojo() {
		VMMemorySizeTotal oil = new VMMemorySizeTotal();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
	...
	public void testXML() throws Exception {
		String oilXML = "<vm_memory_total xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(VMMemorySizeTotal.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		VMMemorySizeTotal oil = (VMMemorySizeTotal) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:vm_memory_total");
