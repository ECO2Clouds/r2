 ...
 */
public class PowerCurrentvaAggregatedTest {

	@Test 
	public void pojo() {
		PowerCurrentvaAggregated power = new PowerCurrentvaAggregated();
		power.setClock(10l);
		power.setName("name");
	...
	public void testXML() throws Exception {
		String co2XML = "<power_current_va_aggregated xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
							+ "<clock>1381512236</clock>"
							+ "<unity>g\\/kWh</unity>"
							+ "<name>Co2 producted per kWh</name>"
						+ "</power_current_va_aggregated>";
		
		JAXBContext jaxbContext = JAXBContext.newInstance(PowerCurrentvaAggregated.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		PowerCurrentvaAggregated co2 = (PowerCurrentvaAggregated) jaxbUnmarshaller.unmarshal(new StringReader(co2XML));
	...
	public void objectToXml() throws Exception {
		PowerCurrentvaAggregated co2 = new PowerCurrentvaAggregated();
		co2.setClock(10l);
		co2.setName("name");
		co2.setUnity("units");
		co2.setValue(1.0d);
		...
		XPath xpath = XPath.newInstance("//bnf:power_current_va_aggregated");
