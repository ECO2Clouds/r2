 ...
 */
public class SystemCPULoadTest {
	...
	public void testXML() throws Exception {
		String oilXML = "<system_cpu_load xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(SystemCPULoad.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		SystemCPULoad oil = (SystemCPULoad) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		SystemCPULoad oil = new SystemCPULoad();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
		...
		XPath xpath = XPath.newInstance("//bnf:system_cpu_load");
