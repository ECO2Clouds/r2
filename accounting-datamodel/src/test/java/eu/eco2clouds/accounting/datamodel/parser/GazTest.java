...
public class GazTest {
	...
	public void pojo() {
		...
		assertEquals(10l, co2.getClock().longValue());
		assertEquals(1.0d, co2.getValue().doubleValue(), 0.0001);
		assertEquals("name", co2.getName());
		assertEquals("units", co2.getUnity());
	}
	
	@Test
	public void testXML() throws Exception {
		String co2XML = "<Co2 xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(Co2.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		Co2 co2 = (Co2) jaxbUnmarshaller.unmarshal(new StringReader(co2XML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:Co2");
