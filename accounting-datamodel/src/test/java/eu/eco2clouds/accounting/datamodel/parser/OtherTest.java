...
public class OtherTest {
	...
	public void pojo() {
		...
		other.setClock(10l);
		other.setName("name");
		other.setUnity("units");
		other.setValue(1.0d);
		
		assertEquals(10l, other.getClock().longValue());
		assertEquals(1.0d, other.getValue().doubleValue(), 0.0001);
		assertEquals("name", other.getName());
		assertEquals("units", other.getUnity());
	}
	
	@Test
	public void testXML() throws Exception {
		String otherXML = "<Other xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(Other.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		Other other = (Other) jaxbUnmarshaller.unmarshal(new StringReader(otherXML));
		
		assertEquals(1381512236l, other.getClock().longValue());
		assertEquals(94.0d, other.getValue().doubleValue(), 0.0001);
		assertEquals("Co2 producted per kWh", other.getName());
		assertEquals("g\\/kWh", other.getUnity());
	}
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:Other");
