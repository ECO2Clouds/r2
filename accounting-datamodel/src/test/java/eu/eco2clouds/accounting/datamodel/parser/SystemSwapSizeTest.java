 ...
 */
public class SystemSwapSizeTest {

	@Test 
	public void pojo() {
		SystemSwapSize oil = new SystemSwapSize();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
	...
	public void testXML() throws Exception {
		String oilXML = "<system_swap_size xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(SystemSwapSize.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		SystemSwapSize oil = (SystemSwapSize) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:system_swap_size");
