 ...
 */
public class SystemPowerConsumptionTest {

	@Test 
	public void pojo() {
		SystemPowerConsumption oil = new SystemPowerConsumption();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
	...
	public void testXML() throws Exception {
		String oilXML = "<system_power_consumption xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(SystemPowerConsumption.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		SystemPowerConsumption oil = (SystemPowerConsumption) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:system_power_consumption");
