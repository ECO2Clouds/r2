 ...
 */
public class OneAvailabilityTest {

	@Test 
	public void pojo() {
		OneAvailability hostAvailability = new OneAvailability();
	...
	public void testXML() throws Exception {
		String co2XML = "<one_availability xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(OneAvailability.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		OneAvailability co2 = (OneAvailability) jaxbUnmarshaller.unmarshal(new StringReader(co2XML));
	...
	public void objectToXml() throws Exception {
		OneAvailability co2 = new OneAvailability();
		co2.setClock(10l);
		co2.setName("name");
		co2.setUnity("units");
		co2.setValue(1.0d);
		...
		XPath xpath = XPath.newInstance("//bnf:one_availability");
