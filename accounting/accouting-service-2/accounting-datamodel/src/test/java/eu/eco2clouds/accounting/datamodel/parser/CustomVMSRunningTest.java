 ...
 */
public class CustomVMSRunningTest {

	@Test 
	public void pojo() {
		CustomVMSRunning oil = new CustomVMSRunning();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
	...
	public void testXML() throws Exception {
		String oilXML = "<custom_vms_running xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(CustomVMSRunning.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		CustomVMSRunning oil = (CustomVMSRunning) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:custom_vms_running");
