 ...
 */
public class SystemCPUUtilPercTest {

	@Test 
	public void pojo() {
		SystemCPUUtilPerc systemCPULoad = new SystemCPUUtilPerc();
	...
	public void testXML() throws Exception {
		String oilXML = "<system_cpu_util_perc xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
							+ "<clock>1381512236</clock>"
							+ "<unity>g\\/kWh</unity>"
							+ "<name>Co2 producted per kWh</name>"
						+ "</system_cpu_util_perc>";
		
		JAXBContext jaxbContext = JAXBContext.newInstance(SystemCPUUtilPerc.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		SystemCPUUtilPerc oil = (SystemCPUUtilPerc) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		SystemCPUUtilPerc oil = new SystemCPUUtilPerc();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
		...
		XPath xpath = XPath.newInstance("//bnf:system_cpu_util_perc");
