...
public class TotalTest {
	...
	public void testXML() throws Exception {
		String totalXML = "<Total xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		Total total = (Total) jaxbUnmarshaller.unmarshal(new StringReader(totalXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:Total");
