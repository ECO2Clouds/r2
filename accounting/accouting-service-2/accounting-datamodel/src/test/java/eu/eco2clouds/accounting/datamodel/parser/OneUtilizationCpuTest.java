 ...
 */
public class OneUtilizationCpuTest {

	@Test 
	public void pojo() {
		OneUtilizationCpu oil = new OneUtilizationCpu();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
	...
	public void testXML() throws Exception {
		String oilXML = "<one_utilization_cpu xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(OneUtilizationCpu.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		OneUtilizationCpu oil = (OneUtilizationCpu) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:one_utilization_cpu");
