 ...
 */
public class CustomCpuUtilizationTest {

	@Test 
	public void pojo() {
		CustomCpuUtilization oil = new CustomCpuUtilization();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
	...
	public void testXML() throws Exception {
		String oilXML = "<custom_cpu_utilization xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
							+ "<clock>1381512236</clock>"
							+ "<unity>g\\/kWh</unity>"
							+ "<name>Co2 producted per kWh</name>"
						+ "</custom_cpu_utilization>";
		
		JAXBContext jaxbContext = JAXBContext.newInstance(CustomCpuUtilization.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		CustomCpuUtilization oil = (CustomCpuUtilization) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:custom_cpu_utilization");
