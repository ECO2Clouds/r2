 ...
 */
public class PowerCurrentwhRealTest {

	@Test 
	public void pojo() {
		PowerCurrentwhReal oil = new PowerCurrentwhReal();
		oil.setClock(10l);
		oil.setName("name");
		oil.setUnity("units");
		oil.setValue(1.0d);
	...
	public void testXML() throws Exception {
		String oilXML = "<power_currentwh_real xmlns=\"http://accounting.eco2clouds.eu/doc/schemas/xml\">"
							+ "<value>94.0</value>"
							+ "<clock>1381512236</clock>"
							+ "<unity>g\\/kWh</unity>"
							+ "<name>Co2 producted per kWh</name>"
						+ "</power_currentwh_real>";
		
		JAXBContext jaxbContext = JAXBContext.newInstance(PowerCurrentwhReal.class);
		Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();
		PowerCurrentwhReal oil = (PowerCurrentwhReal) jaxbUnmarshaller.unmarshal(new StringReader(oilXML));
	...
	public void objectToXml() throws Exception {
		...
		XPath xpath = XPath.newInstance("//bnf:power_currentwh_real");
